...
BENCHMARK_TEMPLATE(vector_append, std::allocator<int>)->Range(1, 1<<24)->UseRealTime();
BENCHMARK_TEMPLATE(vector_append, containers::thread_arena_allocator<int>)->Range(1, 1<<24)->UseRealTime();
BENCHMARK_TEMPLATE(deque_append, std::allocator<int>)->Range(1, 1<<24)->UseRealTime();
BENCHMARK_TEMPLATE(deque_append, containers::thread_arena_allocator<int>)->Range(1, 1<<24)->UseRealTime();
BENCHMARK_TEMPLATE(set_append, std::allocator<int>)->Range(1, 1<<24)->UseRealTime();
BENCHMARK_TEMPLATE(set_append, containers::thread_arena_allocator<int>)->Range(1, 1<<24)->UseRealTime();
BENCHMARK_TEMPLATE(unordered_set_append, std::allocator<int>)->Range(1, 1<<24)->UseRealTime();
BENCHMARK_TEMPLATE(unordered_set_append, containers::thread_arena_allocator<int>)->Range(1, 1<<24)->UseRealTime();
